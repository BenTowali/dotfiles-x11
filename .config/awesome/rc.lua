...
-- Themes defining colours, icons, font and wallpapers.
...
globalkeys = gears.table.join(
	...
	end, { description = "show windows", group = "client" }),
	...
	awful.key({ modkey }, "w", awesome.restart, { description = "reload awesome", group = "awesome" }),
...
awful.rules.rules = {
	...
	{ rule = { class = "Raindrop.io" }, properties = { screen = 1, tag = "2" } },
